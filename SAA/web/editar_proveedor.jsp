...
<%
    /**
     * Para editar el proveedor seleccionado
     */
                    ...
                    <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="Proveedores">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <input type="text" class="form-control" id="CLS" name="CLS" placeholder="CLS" maxlength="5" onKeyPress="return tabular(event, this)"  value="<%=cls_pro%>"  />
                                </div>
