                    ...
                    <tbody>
                        <%                            /**
                            ...
                            try {
                                con.conectar();
                                /**
                                 * Se buscan todas las claves que estén
                                 * disponibles en los 2 catálogos
                                 *
                                 * tb_cat2014 y tb_cat2015 son los catálogos que
                                 * se han manejado hasta ahora
                                 */
                                ...
                                while (rset.next()) {
                                    ...
                                    /**
                                     * Si estaá en la tabla 2014 quiere decir
                                     * que corresponde a ambos catálogos
                                     */
                                    ...
                                    /**
                                     * Dias de diferencia con respecto a la
                                     * primera vez que se requirió la clave
                                     */
                                    ...
                                    /**
                                     * Días de diferencia con respecto a la
                                     * primera vez que se ingresó el insumo
                                     */
                                    ...
                                    /**
                                     * Total de meses de diferencia que se
                                     * utilizarán como 'sobreabasto'
                                     */
                                    ...
                                    /**
                                     * Se obtiene la existencia de la clave,
                                     * sumando lo de lote menos lo que está
                                     * apartado para que de lo disponible
                                     */
                                    ...
                                    /**
                                     * Se obtiene un aproximado de lo solicitado
                                     * por clave
                                     */
                                    ...
                                    /**
                                     * Si lo solicitado es menos a lo
                                     * remisionado entonces lo solicitado será
                                     * igual a lo entregado. Esto por cambios de
                                     * presentación
                                     */
                                    ...
                                    /**
                                     * Se calcula el ASF con base en lo
                                     * remisionado
                                     */
                                    if (remisionadoClave > 0) {
                                        /**
                                         * Remisionado por clave entre la
                                         * diferencia de días por 30 (calculo de
                                         * consumo promedio mensual)
                                         */
                                        CPM = (remisionadoClave / difd) * 30;
                                        /**
                                         * ASF total de existencias entre el
                                         * consumo promedio mensual
                                         */
