...
<html>
    ...
    conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/isem_ubicaciones","root","eve9397");
    
    /*Establecemos la ruta del reporte*/ 
    File reportfile = new File(application.getRealPath("consult.jasper")); 
