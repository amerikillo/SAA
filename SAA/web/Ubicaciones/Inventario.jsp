...
<html>
    ...
    <body>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            %>
            Total Capturado: <%=formatter.format(Total)%>
            <hr/>
            <form action="Inventario.jsp" method="post">
                <div class="container">
                    <div class="row">
                        <div><h5>
                                Ingresa CB Ubica:
                                <input type="text" id="txtf_cb" name="txtf_cb" placeholder="Ingrese CB" size="20" class="text-center" onchange="this.form.submit();" >
                                &nbsp;&nbsp;
                                Ingresa CB Med:
                                <input type="text" id="txtf_cdm" name="txtf_cdm" placeholder="Ingrese CB" size="15" class="text-center" onchange="this.form.submit();" >
                                &nbsp;&nbsp;
                                <textarea name="descrip" id="descrip" onKeyUp="Descripcion()" placeholder="Ingrese Descripción" cols="50" rows="5"></textarea><datalist id="Descripciones"></datalist>
                                <!--input type="text" name="descrip" id="descrip" onKeyUp="Descripcion()" placeholder="Ingrese Descripción" /><datalist id="Descripciones"></datalist-->
                                &nbsp;&nbsp;
                                <button class="btn btn-sm btn-primary" id="btn-buscar">BUSCAR&nbsp;<label class="glyphicon glyphicon-search"></label></button>
                                &nbsp;
                                <a class="btn btn-sm btn-success" href="Consultas.jsp">REGRESAR&nbsp;<label class="glyphicon glyphicon-hand-left"></label></a></h5></div>
                    </div>
                        ...
                        <tbody>                            
                            ...
                            <tr>
                                <th>Presentación</th><td><input type="text" id="pzc" name="pzc" value="<%//=pzas%>" placeholder="" class="text-center" onkeypress="return justNumbers(event);"/>
                                    <select id="selectR" onchange="Resto();">
    ...
    <script>
                        ...
                        function Resto() {
                            var resto = document.getElementById('selectR').value;
                            //alert(resto);

                            if (resto === "--Resto--") {
                                document.getElementById('pzc').value = "RESTO";
                            } else {
