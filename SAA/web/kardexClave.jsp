                                ...
                                try {
                                    ...
                                    while (rset.next()) {
                                        ...
                                        if (rset.getString(2).equals("51")) {
                                            ResultSet rset2 = con.consulta("select F_NomCli from tb_factura f, tb_uniatn u where u.F_ClaCli = f.F_ClaCli and F_ClaDoc = '" + rset.getString(12) + "' ");
                                            while (rset2.next()) {
