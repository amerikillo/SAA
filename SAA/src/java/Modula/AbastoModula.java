...
public class AbastoModula {
    ...
    public void AbastoModula(String F_OrdCom, String F_FolRemi) {
        ...
        try {
            ...
            try {
                /**
                 * Para insertar los pedidos de deposito en módula
                 *
                 * Primero se eliminan los avisos previos, comenzando por
                 * cabecera y despues detallse
                 */
                ...
                while (rset.next()) {
                    /**
                     * Se inserta cabecera del pedido de depósito
                     */
