            ...
            if (request.getParameter("accion").equals("Guardar")) {
                try {
                    ...
                    while (rsetDatos.next()) {
                        ...
                        con.insertar("insert into tb_compra values (0,'" + F_IndCom + "','" + F_Provee + "','A',curdate(), '" + F_ClaPro + "', '" + F_Piezas + "', '" + F_Costo + "', '" + F_Caja + "', '0', '" + F_Tarimas + "', '" + F_ImpTo + "' ,'" + F_ComTot + "', '" + FolioLote + "', '" + F_FolRemi + "', '" + F_OrdCom + "', '" + F_Origen + "', '" + F_Cb + "', curtime(), '" + F_User + "','" + F_Obser + "') ");
                    ...
                    con.actualizar("update tb_pedidoisem set F_Recibido = '1' where F_NoCompra = '"+F_FolRemi+"'");
                    con.cierraConexion();
